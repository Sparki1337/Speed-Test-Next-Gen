...
# ШАГ 2: Слить изменения из beta
git merge beta
# Если появятся конфликты - разрешите их вручную

# ШАГ 3: Обновить статус на Stable
...
# ШАГ 5: Закоммитить изменение статуса
git add version.py
git commit -m "release: v1.3.0 stable"

# ШАГ 6: Запушить в main
git push origin main

# ШАГ 7: Создать тег для релиза
git tag -a v1.3.0 -m "Release v1.3.0"
git push origin main --tags

# ШАГ 8: Вернуться в beta для дальнейшей разработки
git checkout beta
```

### ✅ Готово! Релиз опубликован в main
