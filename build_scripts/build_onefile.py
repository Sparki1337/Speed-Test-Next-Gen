...
# coding: utf-8
"""
Скрипт сборки приложения Speedtest NextGen в один файл (onefile) с помощью Nuitka.
...
def build(version: str) -> int:
    ...
    print("="*60)
    print("🚀 Сборка Speedtest NextGen (One File)")
    print("="*60)
    ...
    print(f"\n⚙️  Запуск Nuitka...")
    print("⚠️  Сборка в один файл может занять 10-15 минут")
    print("="*60)
    ...
    try:
        ...
        print(f"📁 Результат: build/SpeedTestNextgen.exe")
        print("="*60)
